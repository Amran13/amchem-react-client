    ...
    <section className="py-20 bg-zinc-100">
      <div className="max-w-5xl mx-auto px-4">
        <div className="mb-12 text-center">
          <h2 className="text-3xl text-blue-900 md:text-4xl font-bold tracking-tight">
            Production Operators
          </h2>
        </div>

        <div className="card bg-zinc-200 shadow-xl rounded-3xl">
          <div className="card-body md:p-10 space-y-8">
            ...
            <div className="space-y-5 text-base-content/80 leading-relaxed text-black">
              <p>
